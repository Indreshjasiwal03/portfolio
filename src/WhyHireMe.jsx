        ...
        >
            ...
            <div className="neww">
                <motion.div
                    ...
                    <div className="flex2">
                        <div className="box">
                            ...
                            <h4 className='mid_text'>AIR 89484</h4>
                            <p className='main_text_why'>JEE Mains</p>
                        </div>
                        <div className="box">
                ...
                <motion.div
                    ...
                    <div className="flex2">
                        <div className="box">
                            <img src={gfg} alt="" className='why_logo' />
                            <h4 className='mid_text'>150+</h4>
                            <p className='main_text_why'>GFG Problems Solved</p>
                        </div>
                        <div className="box ">
